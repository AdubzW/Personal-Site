...
The spare room in my basement suite.

## Games

- Unrailed 2 (8 player local or w/lan)
- Halo Infinite (2 players local + lan)
- Rocket League (4 players + lan)

## Need to procure

- One long fold-out table (~170cm).
- Another long fold out table (~170cm long)
- 1x Television for four players.
